...
- Step 3:
  run `pip install uv; uv pip install torch torchvision --index-url https://download.pytorch.org/whl/cu130; uv pip install -r requirements.txt; playwright install`
- Step 4:
